// Explicit "Get in touch" section. Sits between Hero and Experience so a
// visitor lands, reads the bio, and immediately sees how to reach
// Pritika. Larger than the header contact strip (which is utility chrome);
...
export function Contact() {
  return (
    <section id="contact" className="pt-8 pb-12 md:pt-10 md:pb-16 border-t border-border">
      <h2 className="section-heading">Get in touch</h2>
      <p className="mt-4 text-muted leading-relaxed max-w-content">
        Cold emails welcome. Fastest reach is direct email; resume is one click below.
      </p>
      <div className="mt-6 contact-cluster">
        <a
          href={`mailto:${EMAIL}`}
        ...
        >
          <EmailIcon />
          <span className="font-mono text-[14.5px] sm:text-[15.5px] tracking-tight break-all">
            {EMAIL}
          </span>
        </a>
        <a
        ...
        >
          <LinkedInIcon />
          <span className="font-mono text-[14px] tracking-tight">LinkedIn</span>
        </a>
        <a
          href={GITHUB}
          className="contact-pill"
        ...
        >
          <GitHubIcon />
          <span className="font-mono text-[14px] tracking-tight">GitHub</span>
        </a>
      </div>
    </section>
  );
